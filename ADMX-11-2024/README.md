...
| Microsoft Defender Antivirus | DisableLocalAdminMerge | Configure local administrator merge behavior for lists | Machine | This policy setting controls whether or not complex list settings configured by a local administrator are merged with Group Policy settings. This setting applies to lists such as threats and Exclusions.
   ...
   1 (Enabled)
   0 (Disabled) |
| Microsoft Defender Antivirus | DisableRoutinelyTakingAction | Turn off routine remediation | Machine | 
...
| Scan | Scan_ScheduleTime | Specify the time of day to run a scheduled scan | Machine | This policy setting allows you to specify the time of day at which to perform a scheduled scan. The time value is represented as the number of minutes past midnight (00:00).  For example, 120 (0x78) is equivalent to 02:00 AM. By default, this setting is set to  a time value of 2:00 AM. The schedule is based on local time on the computer where the scan is executing.
   ...
   0 (minimum)
   1440 (maximum) |
| Scan | Scan_MissedScheduledScanCountBeforeCatchup | Define the number of days after which a catch-up scan is forced | Machine | 
...
| Scan | Scan_MissedScheduledScanCountBeforeCatchup | Define the number of days after which a catch-up scan is forced | Machine | 
   ...
   2 (minimum)
   20 (maximum) |
| Scan | Scan_LowCpuPriority | Configure low CPU priority for scheduled scans | Machine | 
   ...
   1 (Enabled)
   0 (Disabled) |
| Scan | Scan_QuickScanIncludeExclusions | Scan excluded files and directories during quick scans | Machine | 
...
| Scan | Scan_QuickScanIncludeExclusions | Scan excluded files and directories during quick scans | Machine | 
     ...
     "0" = "0" 
     "1" = "1" |
| Security Intelligence Updates | MeteredConnectionUpdates | Allows Microsoft Defender Antivirus to update and communicate over a metered connection. | Machine | 
    Disabled (Default): 
   ...
   1 (Enabled)
   0 (Disabled) |
| Network Protection | AllowNetworkProtectionOnWinServer | This settings controls whether Network Protection is allowed to be configured into block or audit mode on Windows Server. | Machine | 
    Disabled (Default): 
   ...
   1 (Enabled)
   0 (Disabled) |
| Network Inspection System | AllowSwitchToAsyncInspection | Turn on asynchronous inspection | Machine | 
   ...
   1 (Enabled)
   0 (Disabled) |
| Network Inspection System | DisableDatagramProcessing | This setting controls datagram processing for network protection. | Machine | 
    Disabled (Default): 
   ...
   1 (Enabled)
   0 (Disabled) |
| Network Inspection System | EnableConvertWarnToBlock | Convert warn verdict to block | Machine | 
...
| Security Intelligence Updates | SignatureUpdate_SharedSignaturesLocation | Define security intelligence location for VDI clients. | Machine | This policy setting allows you to define the security intelligence location for VDI-configured computers. 
...
| Security Intelligence Updates | SignatureUpdate_SharedSignaturesLocationUpdateAtScheduledTimeOnly | Configure security intelligence updates according to the scheduler for VDI clients. | Machine | This policy setting allows you to configure security intelligence updates according to the scheduler for VDI-configured computers. It is used together with the shared security intelligence location (SharedSignaturesLocation).
   ...
   1 (Enabled)
   0 (Disabled) |
| Security Intelligence Updates | SignatureUpdate_DisableScanOnUpdate | Turn on scan after security intelligence update | Machine | This policy setting allows you to configure the automatic scan which starts after a security intelligence update has occurred.
   ...
   0 (Enabled)
   1 (Disabled) |
| Security Intelligence Updates | SignatureUpdate_DisableScheduledSignatureUpdateonBattery | Allow security intelligence updates when running on battery power | Machine | This policy setting allows you to configure security intelligence updates when the computer is running on battery power.
   ...
   0 (Enabled)
   1 (Disabled) |
| Security Intelligence Updates | SignatureUpdate_DisableUpdateOnStartupWithoutEngine | Initiate security intelligence update on startup | Machine | This policy setting allows you to configure security intelligence updates on startup when there is no antimalware engine present.
...
| Security Intelligence Updates | SignatureUpdate_SignatureUpdateInterval | Specify the interval to check for security intelligence updates | Machine | This policy setting allows you to specify an interval at which to check for security intelligence updates. The time value is represented as the number of hours between update checks. Valid values range from 1 (every hour) to 24 (once per day).
   ...
   0 (minimum)
   24 (maximum) |
| Security Intelligence Updates | SignatureUpdate_UpdateOnStartup | Check for the latest virus and spyware security intelligence on startup | Machine | This policy setting allows you to manage whether a check for new virus and spyware security intelligence will occur immediately after service startup.
...
| MAPS | DisableBlockAtFirstSeen | Configure the 'Block at First Sight' feature | Machine | This feature ensures the device checks in real time with the Microsoft Active Protection Service (MAPS) before allowing certain content to be run or accessed. If this feature is disabled, the check will not occur, which will lower the protection state of the device.
   ...
   0 (Enabled)
   1 (Disabled) |
| MAPS | Spynet_LocalSettingOverrideSpynetReporting | Configure local setting override for reporting to Microsoft MAPS | Machine | This policy setting configures a local override for the configuration to join Microsoft MAPS. This setting can only be set by Group Policy.
   ...
   1 (Enabled)
   0 (Disabled) |
| MAPS | SpynetReporting | Join Microsoft MAPS | Machine | This policy setting allows you to join Microsoft MAPS. Microsoft MAPS is the online community that helps you choose how to respond to potential threats. The community also helps stop the spread of new malicious software infections.
...
| MAPS | SpynetReporting | Join Microsoft MAPS | Machine | This policy setting allows you to join Microsoft MAPS. Microsoft MAPS is the online community that helps you choose how to respond to potential threats. The community also helps stop the spread of new malicious software infections.
    ...
    In Windows 10, Basic membership is no longer available, so setting the value to 1 or 2 enrolls the device into Advanced membership. | At least Windows Vista | dropdownList | Join Microsoft MAPS | Software\Policies\Microsoft\Windows Defender\Spynet | SpynetReporting (required) | List items: 
     ...
     "1" = "Basic MAPS" 
     "2" = "Advanced MAPS" |
| MAPS | SubmitSamplesConsent | Send file samples when further analysis is required | Machine | 
...
| Client Interface | UX_Configuration_UILockdown | Enable headless UI mode | Machine | 
   ...
   1 (Enabled)
   0 (Disabled) |
| Client Interface | UX_Configuration_SuppressRebootNotification | Suppresses reboot notifications | Machine | 
   ...
   1 (Enabled)
   0 (Disabled) |
| Client Interface | UX_Configuration_Notification_Suppress | Suppress all notifications | Machine | Use this policy setting to specify if you want Microsoft Defender Antivirus notifications to display on clients.
   ...
   1 (Enabled)
   0 (Disabled) |
| MpEngine | MpEngine_MpCloudBlockLevel | Select cloud protection level | Machine | 
...
| MpEngine | MpEngine_MpBafsExtendedTimeout | Configure extended cloud check | Machine | 
...
| MpEngine | MpEngine_MpBafsExtendedTimeout | Configure extended cloud check | Machine | 
   ...
   0 (minimum)
   50 (maximum) |
| MpEngine | MpEngine_EnableFileHashComputation | Enable file hash computation feature | Machine | 
   ...
   1 (Enabled)
   0 (Disabled) |
| MpEngine | DisableGradualRelease | Disable gradual rollout of Microsoft Defender updates. | Machine | Enable this policy to disable gradual rollout of Defender updates.
   ...
   1 (Enabled)
   0 (Disabled) |
| Network Protection | ExploitGuard_EnableNetworkProtection | Prevent users and apps from accessing dangerous websites | Machine | 
...
| Network Protection | ExploitGuard_EnableNetworkProtection | Prevent users and apps from accessing dangerous websites | Machine | 
    ...
    Same as Disabled.
     ...
     "1" = "Block" 
     "2" = "Audit Mode" |
| Controlled Folder Access | ExploitGuard_ControlledFolderAccess_EnableControlledFolderAccess | Configure Controlled folder access | Machine | 
...
| Attack Surface Reduction | ExploitGuard_ASR_Rules | Configure Attack Surface Reduction rules | Machine | 
...
| Attack Surface Reduction | ExploitGuard_ASR_ASROnlyExclusions | Exclude files and paths from Attack Surface Reduction Rules | Machine | 
...
| Attack Surface Reduction | ExploitGuard_ASR_ASROnlyPerRuleExclusions | Apply a list of exclusions to specific attack surface reduction (ASR) rules | Machine | 
...
| Controlled Folder Access | ExploitGuard_ControlledFolderAccess_AllowedApplications | Configure allowed applications | Machine | 
...
| Controlled Folder Access | ExploitGuard_ControlledFolderAccess_ProtectedFolders | Configure protected folders | Machine | 
...
| Features | Features_TDTFeatureEnabled | Intel TDT Integration Level | Machine | This policy setting configures the Intel TDT integration level for Intel TDT-capable devices.
